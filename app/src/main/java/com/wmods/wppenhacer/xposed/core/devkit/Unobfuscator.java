...
public class Unobfuscator {
    ...
    public synchronized static Method loadSendMessageMethod(ClassLoader loader) throws Exception {
    	return UnobfuscatorCache.getInstance().getMethod(loader, () -> {
    	    var method = findFirstMethodUsingStrings(loader, StringMatchType.Contains, "chat_settings_store/get_row_id");
            if (method == null) throw new Exception("SendMessage method not found");
            
            return method;
            });            
    }
    
    public synchronized static Class<?> loadUserJidClass(ClassLoader loader) throws Exception {
    	return findFirstClassUsingName(loader, StringMatchType.EndsWith, "jid.UserJid");
    
    }
    
    public synchronized static Class<?> loadGroupJidClass(ClassLoader loader) throws Exception {
    	return findFirstClassUsingName(loader, StringMatchType.EndsWith, "jid.GroupJid");
    }
