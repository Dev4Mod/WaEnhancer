...
public class FeatureCatalog {
        ...
        private static List<SearchableFeature> buildFeatureCatalog(Context context) {
                ...
                catalog.add(new SearchableFeature("video_note_attachment",
                                context.getString(R.string.video_note_attachment),
                                context.getString(R.string.video_note_attachment_sum),
                                SearchableFeature.Category.GENERAL_CONVERSATION,
                                SearchableFeature.FragmentType.GENERAL,
                                "conversation",
                                Arrays.asList("video", "note", "attachment", "ptv")));
